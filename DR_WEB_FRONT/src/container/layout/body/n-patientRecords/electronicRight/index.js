...
export default class Electronic extends Component {
  ...
  render() {
    let ss = null;
    let {diagnosisWay,disname,orgidDic,name, age, sex, type, upstamp, temperature, breath, pulse, systolicPressure, diastolicPressure, casetype,chOrderList,weOrderList} = this.state;
    let zy;
    let xy;
    if(diagnosisWay = '1') {
      zy = disname;
