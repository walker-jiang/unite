    ...
    <div className="homeTabs">
      <Tabs defaultActiveKey="待接诊" onChange={this.callback} type="card" >
        <TabPane tab="待接诊" key="待接诊">
          <Table columns={this.props.columns}  pagination={{pageSize:8}}  dataSource={this.props.data}  />
        </TabPane>
        <TabPane tab="接诊中" key="接诊中">
          <Table columns={this.props.columns2} pagination={{pageSize:8}} dataSource={this.props.data2}  />
        </TabPane>
