  ...
  return(
    <div className="homeTabs">
      <Tabs defaultActiveKey="待接诊" onChange={this.callback} type="card" >
        ...
        <div style={{marginTop:"-47px",background:"#F9F9F9",border:"1px solid #D7D7D7",height:"50px",lineHeight:"50px",paddingLeft:"10px"}}>• 共有{length1}位已就诊患者记录</div>
        </TabPane>
        <TabPane tab="接诊中" key="接诊中">
          <Table columns={this.props.columns2} pagination={{pageSize:5}} dataSource={this.props.data2}  />
        <div style={{marginTop:"-47px",background:"#F9F9F9",border:"1px solid #D7D7D7",height:"50px",lineHeight:"50px",paddingLeft:"10px"}}>• 共有{length2}位已就诊患者记录</div>
        </TabPane>
        <TabPane tab="已完成" key="已完成">
          <Table columns={this.props.columns3} pagination={{pageSize:5}} dataSource={this.props.data3}  />
        <div style={{marginTop:"-47px",background:"#F9F9F9",border:"1px solid #D7D7D7",height:"50px",lineHeight:"50px",paddingLeft:"10px"}}>• 共有{length3}位已就诊患者记录</div>
        </TabPane>
      </Tabs>
