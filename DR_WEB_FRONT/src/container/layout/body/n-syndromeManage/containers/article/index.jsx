...
class ClinicalGuideline extends Component {
  state = {
    visible: false,
    addVisible: false,
    data: [
    ...
    return (
      <div className="HomeIndex">
        <div className="HomeIndex_div">
          <p>临床指南管理</p><hr/><hr className="hr1"/>
...
const ClinicalGuidelineIndex = Form.create()(ClinicalGuideline);
export default ClinicalGuidelineIndex;
