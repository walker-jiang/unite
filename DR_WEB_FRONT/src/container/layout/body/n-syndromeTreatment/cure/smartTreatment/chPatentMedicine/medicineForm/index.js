...
import Diagnose from '../../../../../treatment/treatItem/drAdviceManage/chHerbalMedicine/herbalForm/diagnose';
          ...
          <Row>
            ...
            <Col span={16}>
              <FormItem
                ...
                >
                  {getFieldDecorator('addQuickly')(
                    <QuickAddMedicine placeholder='请输入中成药首字母快速添加' icon='#0A6ECB' ref={ref => this.quickAddMedicine = ref} getQuickData = {this.addMedicineData.bind(this)}/>
                  )}
                </FormItem>
            </Col>
          </Row>
