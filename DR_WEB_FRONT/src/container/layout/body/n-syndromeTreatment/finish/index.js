    ...
    return (
        <Container >
          ...
          <Body>
            ...
            <Footer>
              <SureButton type="primary" htmlType="submit" onClick={() => {this.props.onStep(4)}}>查看患者医嘱</SureButton>
              <BorderButton type="primary" onClick={() => {this.props.onStep(0)}}>选择其它患者</BorderButton>
            </Footer>
          </Body>
        </Container>
    )
