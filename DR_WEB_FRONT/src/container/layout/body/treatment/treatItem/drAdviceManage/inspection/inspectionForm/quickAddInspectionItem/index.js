...
class QuickAddInspectionItem extends Component {
          ...
          (
            <Result>
              <SpecTable
                ...
                locale={{emptyText: loadStatus ? <DataLoading type='data_loading' /> : '暂无检查项目数据' }}
                columns={columns}
...
export default HocAddTable(QuickAddInspectionItem, params)
/*
@作者：姜中希
@日期：2018-08-22
@描述：快速添加检查项目
