  ...
  render () {
    return (
      <Container>
        ...
        <AddList>
          <ListItem onClick={() => { this.actionType(1) }} >
            <Icon src={inspection} hover={inspection_hover}/>检验
          </ListItem>
          <Line>|</Line>
          <ListItem onClick={() => { this.actionType(2) }} >
          ...
          <Line>|</Line>
          <ListItem onClick={() => { this.actionType(6) }} >
             <Icon src={west_cure} hover={west_cure_hover}/>西医治疗
           </ListItem>
          <Line>|</Line>
          <ListItem onClick={() => { this.actionType(7) }} >
