...
class YZClassify extends Component {
    constructor(props) {
        super(props);
        this.state = {
            classifyModelVisiable: false,
            classifyOkLoading: false,
            tmpModelVisiabl: false,
            _treeData: [],
            _tableData: [],
            _currentTreeItem: {}
        };
        this._tableColumn = [
                ...
                { title: '操作', key: 'action',
                    render: (text, record) => (
                        <span>
                            <a href="javascript:;" onClick={this.handleTableCheck}>查看</a>
    ...
    _handleGetList = () => {
        if (getList) {
            getList({temtype:1, personid:6, orgid:10000, provid:1}).then((data) => {
    ...
    /****************** table的删改查 S***********************/
    handleTableCheck = (type) => {
        //模板 1 分类 0
        type? this.handleClassifyhowModal: ""
    }
            ...
            <Card>
                <Card>
                    <p>
                        ...
                        <Button type="primary" onClick={() => newTmp('yz')}>新建模板</Button>
                    </p>
                    <Row>
                        <Col span={8}>
                ...
                }} getDataFun={getList} getDataParam={{temtype: 1, personid: 6, orgid: 10000, provid:1}}/>
