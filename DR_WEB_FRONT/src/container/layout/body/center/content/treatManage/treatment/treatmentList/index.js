...
import Template from "../../../../../../../rightAssistBar/medicalRecordWriting/medicalRecordTemplate.js";
    ...
    return (
      <Container>
        <SpecForm onSubmit={this.handleSubmit}>
          ...
          <Row>
            <Col span={13}>
              <SureButton type="primary" htmlType="submit">保存</SureButton>
