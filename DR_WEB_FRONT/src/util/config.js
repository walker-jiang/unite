...
module.exports = { 
    ...
    templateManagement: 'http://192.168.103.166:8088/',    //模板管理 ylm
    config_AssistBar_url: 'http://219.234.5.58:8088/', // 测试病历书写-----易超文
    config_AssistBar_urlTwo: 'http://219.234.5.58:8088/', // 测试病历书写-----尧尧
    ...
    SDT : 'http://192.168.103.166:8763/', // 辨证论治管理后台服务地址 ylm
